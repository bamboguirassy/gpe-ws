...
/**
 * PayementHeureComplementaire
 *
 * @ORM\Table(name="payement_heure_complementaire", indexes={@ORM\Index(name="user_paiement", columns={"user_paiement"}), @ORM\Index(name="anneeacad", columns={"anneeacad"}), @ORM\Index(name="user_mandatement_2", columns={"user_mandatement"}), @ORM\Index(name="enseignant", columns={"enseignant"}), @ORM\Index(name="user_mandatement", columns={"user_mandatement", "user_paiement", "enseignant", "anneeacad"})})
 * @ORM\Entity
 */
class PayementHeureComplementaire
{
    /**
     * @var int
     *
