...
<form *ngIf="'<?= $entity_class_name ?>'|clonable" class="form" role="form" #<?= $entity_var_singular ?>Form="ngForm" autocomplete="off">
    <p-fieldset legend="Clonage <?= $entity_var_singular ?>" [toggleable]="true">
        <p-toolbar>
            ...
            <button [disabled]="<?= $entity_var_singular ?>Form.invalid" type="button" (click)="clone<?= $entity_class_name ?>()"
